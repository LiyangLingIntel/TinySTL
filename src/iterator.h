//
// Created by Liyang Ling on 6/4/2020.
//
...
namespace TinySTL {
    ...
    inline typename iterator_traits<Iteration>::difference_type* differenceType(const Iteration& it) {
        return static_cast<typename iterator_traits<Iteration>::difference_type*>(0);
    }
}
